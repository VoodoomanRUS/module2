...
//        System.out.println(flatMapResult);
        ...
        //Эксперименты с паралелльными стримами
        AtomicInteger atomicInteger = new AtomicInteger();
        long start = System.currentTimeMillis();
        List<Integer> collect = Stream.generate(() -> atomicInteger.incrementAndGet())
                .limit(1_000_000)
                .parallel()
                .map(e -> e + 1)
        ...
        List<Integer> collect2 = Stream.generate(() -> atomicInteger.incrementAndGet())
                .limit(1_000_000)
                .map(e -> e + 1)
                .collect(Collectors.toList());
